...
def plot_signals(deformation_set, signal_var_names = ['inductance']):
...
def plot_signals_aligned(deformation_set, signal_var_names = ['inductance'], title_fontsize=8):
    ...
    index = 0
    for row, deformation_name in enumerate(deformation_set.get_deformation_names_sorted()):
        deformation_trials = deformation_set.get_trials_for_gesture(deformation_name)
