...
# Utility function to extract deformation name from filename
def extract_deformation_name( filename ):
    # leaf = path_leaf(filename)
    tokenSplitPos = filename.index('_')
    deformation_name = filename[:tokenSplitPos]
    return deformation_name