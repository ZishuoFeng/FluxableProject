...
if selected_deformation_set is None:
    ...
    selected_deformation_set = dfdata.get_deformation_set_with_str(map_deformation_sets, "Zi")
    if selected_deformation_set is None:
...
total_confusion_matrix = np.empty((3, 3))
axis = list()
overall_accuracy = list()
param_grid = {
...
for fold in list_folds:
    ...
    random_forest = RandomForestClassifier(random_state=42, n_estimators=100, max_depth=2, min_samples_split=5)
